...
model = iwae_2.importance_vae_2(feature_size, batch_size, stoc_dim_1, stoc_dim_2, det_dim_1, det_dim_2)
model.to(device)
...
for epoch in range(epoch_num):
	...
	for batch_idx in range(batch_num):
		...
		VAE_ELBO = model.VAE_loss(log_p_h, log_p_xGh, log_q_hGx, log_q_h)
		optimizer.zero_grad()
		VAE_ELBO.backward()
		optimizer.step()
	#print(log_p_xGh)
	print('Train epoch: {} VAE_ELBO: {}'.format((epoch + 1),-VAE_ELBO.detach()))
